...
import { IconAlertCircle, IconArrowBackUp, IconLayoutDashboard, IconMapPin, IconMenu2, IconTag } from '@tabler/icons-react';
...
const APP_TITLE = 'Meine Lieblingsorte';
...
const navigation = [
  ...
  { name: 'Orte', href: '/orte', icon: IconMapPin },
];

const externalNavigation = [
  { name: 'Kategorien', href: '/gateway/apps/69d19fcaf3bbc58ce0bfda94?template=list_page', icon: IconTag },
  { name: 'Orte', href: '/gateway/apps/69d19fcd22b3c4519dd04ce3?template=list_page', icon: IconMapPin },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <nav className="px-3 pt-4 space-y-0.5">
          <a
            href="/gateway/apps/69d19fcaf3bbc58ce0bfda94?template=list_page"
